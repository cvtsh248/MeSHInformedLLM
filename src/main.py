...
async def main():
    ...
    # literature = await pyMeSHsearch.find_paper(papers["esearchresult"]["idlist"][1])
    ...
    results = collection.query(
        query_texts=["Which drugs are used in the treatment of renal cell carcinoma"], # Chroma will embed this for you
